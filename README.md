...
An unofficial Model Context Protocol (MCP) server and Python library for interacting with `bcci.tv` data. This package allows you to retrieve cricket tournament schedules, standings, and match summaries.
